...
class IsNullFilterExpressionTest extends KernelTestCase
{
    ...
    public function testThatFilterCanSupportEvaluation()
    {
        ...
        $this->assertTrue($filterExpression->supports($this->entityManager->createQueryBuilder(), 'isNull()'));
        $this->assertTrue($filterExpression->supports($this->documentManager->createQueryBuilder(Page::class), 'isNull()'));
    }
