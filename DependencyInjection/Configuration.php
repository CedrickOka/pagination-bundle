...
class Configuration implements ConfigurationInterface
{
	...
	{
		$supportedFilterTypes = ['array', 'boolean', 'bool', 'integer', 'int', 'float', 'double', 'string', 'datetime'];
							...
							->prototype('array')
								->children()
									->scalarNode('type')
										->defaultValue('string')
										->validate()
											->ifNotInArray($supportedFilterTypes)
											->thenInvalid('The type %s is not supported. Please choose one of '.json_encode($supportedFilterTypes))
										->end()
									->end()
